...
//7. 5.sutunu yazdirin
        List<WebElement> besinciSutunElemnetleri=driver.findElements(By.xpath("//tbody/tr/td[5]"));
        for (WebElement eachData:besinciSutunElemnetleri){
...
//8.Satir ve sutun sayisini parametre olarak alip, hucredeki bilgiyi döndüren bir method olusturun
    ...
    private String dataGetir(int satirNo, int sutunNo) {
        ...
        // //tbody/tr[5]/td[9] -----> normal xpath den locate yolu
        String dinamikXpath = "//tbody/tr["+5+"]/td["+9+"]";
