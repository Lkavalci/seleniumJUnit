...
public class C07_FileUploadTesti extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        WebElement chooseFileButtonu=driver.findElement(By.xpath("//input[@id='file-upload']"));

        String herkesteFarkliOlan=System.getProperty("user.dir");
        String herkesteAyniOlan="/src/test/java/day10_actionClass_Faker_FileTestleri/deneme.txt";
