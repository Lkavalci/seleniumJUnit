    ...
    public void radioButtonTest(){
      ...
      //  b. Cookies’i kabul edin
       driver.findElement(By.xpath("//button[@title='Allow all cookies']")).click();
        ...
        //c. Create an account buton’una basin
        driver.findElement(By.xpath("//a[@id='u_0_0_+s']")).click();


      //  d. Radio button elementlerini locate edin ve size uygun olani secin
       WebElement maleButtonElementi = driver.findElement(By.xpath("(//input[@type='radio'])[2]"));
       WebElement femaleButtonElementi = driver.findElement(By.xpath("//*[@id='u_1_4_Q9']"));
        WebElement customButtonElementi= driver.findElement(By.xpath("//*[@id='u_1_6_go']"));
